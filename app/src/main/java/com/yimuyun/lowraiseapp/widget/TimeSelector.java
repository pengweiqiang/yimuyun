...
import com.yimuyun.lowraiseapp.util.ScreenUtil;
...
public class TimeSelector {
    ...
    public interface ResultHandler {
        void handle(String showTime,String paramTime);
    }
     ...
     * @param selectedDate
     */
//    public void setSelectedCalender(String selectedDate){
//        if(StringUtil.isBlank(selectedDate)){
//            selectedCalender = Calendar.getInstance();
//        }else {
//            selectedCalender.setTime(DateUtil.parse(selectedDate, FORMAT_STR));
//        }
//        startYear = selectedCalender.get(Calendar.YEAR);
//        startMonth = selectedCalender.get(Calendar.MONTH) + 1;
//        startDay = selectedCalender.get(Calendar.DAY_OF_MONTH);
//    }

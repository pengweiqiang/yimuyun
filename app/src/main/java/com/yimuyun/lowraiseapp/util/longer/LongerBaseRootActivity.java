...
/**
 * @author will on 2017/6/17 15:24
 * @email pengweiqiang64@163.com
 * @description
 * @Version
 */

public abstract class LongerBaseRootActivity<T extends BasePresenter> extends RootActivity<T> implements View.OnClickListener{
                ...
                public void run() {
                    ...
                    if (manager.setOutPower((short) value)) {
                        runOnUiThread( new Runnable() {
                            public void run() {
                                Toast.makeText(mContext, getString(R.string._power_now)+value, Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
